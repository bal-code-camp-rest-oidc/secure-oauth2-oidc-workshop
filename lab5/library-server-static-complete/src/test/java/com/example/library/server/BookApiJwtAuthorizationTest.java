...
class BookApiJwtAuthorizationTest {
    ...
    /**
     * Provides a mock instance we can use to test server functionality.
     */
    private MockMvc mockMvc;

    /**
     * Provides a singleton instance we use to convert JSON.
     */
    private ObjectMapper objectMapper = new ObjectMapper();

    /**
     * Before each test method we set a new mock instance.
     */
    @BeforeEach
    void setup() {
    ...
    /**
     * Provides a nested class we use for tests with successful authorization.
     */
    ...
    class CanAuthorize {
        ...
        void verifyGetBook() throws Exception {
            mockMvc
                    .perform(
                            get("/books/{bookId}", DataInitializer.BOOK_CLEAN_CODE_IDENTIFIER).with(
                                    jwt().jwt(jwt -> jwt.tokenValue("token")
                                            .header("alg", "none")
                                            .claim("sub", "bubu")
    ...
    /**
     * Provides a nested class we use for tests with failing authorization.
     */
